...
export class RoleEditModalComponent implements OnInit {
  ...
  constructor(private userService: UserService, private userUpdateRoleService: UserUpdateRolesService, public dialogRef: MatDialogRef<RoleEditModalComponent>,  private notificationService: NotificationService) { }
